...
def main():
    ...
    parser = argparse.ArgumentParser(description="Manage BAET paper trading process")
    parser.add_argument(
        "action", choices=["start", "stop", "status", "emergency-stop"], help="Action to perform"
    )
    parser.add_argument("--config", default="paper", help="Configuration mode (default: paper)")
