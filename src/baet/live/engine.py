...
class LiveTradingEngine:
    ...
    def execute_signal(self, symbol: str, signal: dict[str, Any]) -> dict[str, Any]:
        ...
        max_daily = safety.get("max_daily_trades", 5) if isinstance(safety, dict) else safety.max_daily_trades
        ...
        max_value = safety.get("max_position_value", 100.0) if isinstance(safety, dict) else safety.max_position_value
