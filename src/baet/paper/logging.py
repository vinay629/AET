...
class PaperTradingLogger:
    ...
    def __init__(
        ...
        # Log engine start
        self.log_engine_event("LOGGER_INITIALIZED", {
    ...
    def log_signal_received(self, symbol: str, signal: dict[str, Any]):
        ...
        """
        self._log_json("SIGNAL_RECEIVED", {
            "symbol": symbol,
            "signal": signal,
        })
    ...
    def log_risk_evaluation(
        ...
        """
        self._log_json("RISK_EVALUATION", {
            "symbol": symbol,
            "signal": signal,
            "result": result,
        })
    ...
    def log_order_simulated(
        ...
        """
        self._log_json("ORDER_SIMULATED", {
            "symbol": symbol,
            "side": side,
    ...
    def log_portfolio_update(
        ...
        """
        self._log_json("PORTFOLIO_UPDATE", {
            "action": action,
            "symbol": symbol,
            "cash": cash,
            "positions": positions,
